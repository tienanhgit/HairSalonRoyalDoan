...
CKEDITOR.editorConfig = function (config) {
	...
	config.filebrowserImageUrl = "/Content/plugins/ckfinder/ckfinder.html?type=Images";
	config.filebrowserFlashUrl = "/Content/plugins/ckfinder/ckfinder.html?type=Flash";
