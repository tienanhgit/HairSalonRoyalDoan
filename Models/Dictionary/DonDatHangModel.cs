...
namespace HairSalonRoyalDoan.Models.Dictionary
{
    public class DonDatHangModel
    {
        ...
        public List<DonDatHang> GetDataByNgayTao(DateTime NgayTao)
        {
            try
            {
                List<DonDatHang> dsDonDatHang = new List<DonDatHang>();
                DataTable dt = dataProvider.ExecuteQuery("Proc_DonDatHang_GetData", new object[] { NgayTao }, new List<string>() { "NgayTao" });
